...
import CustomerTracsactionWrapper from "../Screens/Customers/Transaction/CustomerTracsactionWrapper";
...
const pageRoute = createBrowserRouter([
...

  {
    ...
    children: [
      ...
      {
        path: "invoice/pamantIn/:id",
        element: <PamantInWrapper />,
      },

      {
        path: "category",
        element: <CategoryListFormWrapper />,
        children: [
          {
            path: "add-category",
      ...
      {
        path: "transactions",
        element: <TransactionsListWrapper />,
      },
      // {
